 ...
 * @version $Id: ReleaseCheckListTest.php 6952 2012-09-09 14:01:42Z capedfuzz $
 */
class ReleaseCheckListTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSvnEolStyle()
    {
        ...
        foreach(Piwik::globr(PIWIK_DOCUMENT_ROOT, '*') as $file)
        {
            ...
            if(preg_match('/\.(bmp|fdf|gif|deflate|gz|ico|jar|jpg|p12|pdf|png|rar|swf|vsd|z|zip|ttf|so)$/', $file))
            {
                continue;
            }
