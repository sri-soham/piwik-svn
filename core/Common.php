 ...
 */
	...
	/**
	 * Generates crc32 hash similar to the hash generated by the crc32 function
	 * in the mysql
	 * 
	 * Integer type in php is signed, as a result of which crc32 will return
	 * negative integers in many cases. It has to be formatted to unsigned int
	 ...
	 * @return string
	 */
	static public function getCrc32($str)
	{
	 ...
	 *	nullWhenNotNumeric
	 *
	 *	Returns Null when the string given as parameter does not contain digits
	 *	Postgresql cannot compare strings with integers, mysql can. This is causing
	 *	errors for 'segment' queries.
	 *
	 *	@param string	$string
	 *	@return mixed   string or null
	 */
	static public function nullWhenNotNumeric($string)
	{
		# remove all digits
	 ...
	 *	mysql throws a warning and goes on but doesn't throw an error and stop execution;
	 *	postgresql throws error and stops though. This function is to return the strings
	 *	that look like timestamps; if the do not look like timestamps null is returned.
	 *
	 *	@param string	$string
	 *	@return mixed
	 */
	static public function nullWhenNotTime($string)
	{
